...
public class SupportCaseTests
{
    ...
    [Theory]
    [InlineData(1, CasePriority.Normal)]
    [InlineData(2, CasePriority.Normal)]
    [InlineData(3, CasePriority.High)]
    [InlineData(4, CasePriority.High)]
    [InlineData(5, CasePriority.Critical)]
    public void Priority_FollowsSeverityThresholds(int severity, CasePriority expected)
    {
    ...
    public void Priority_ExecutiveEscalation_OverridesLowSeverity()
    {
        ...
        Assert.Equal(CasePriority.Critical, c.Priority);
    }
    ...
    public void ChangeSeverity_Invalid_LeavesPreviousStateIntact()
    {
        ...
        Assert.Equal(CasePriority.High, c.Priority);
    }
